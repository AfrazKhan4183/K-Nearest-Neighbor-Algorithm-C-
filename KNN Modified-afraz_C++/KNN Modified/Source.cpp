...
int main()
{
	...
	int i, j, l;
	int tsc = 200;
	//char gen[200] = { 'F','M','F','F','F','M','F','M','M','F','M','F','M','F','F','F','M','F','M','M' };
	//float h[200] = { 2.13f,1.1f,1.6f,2.0f,1.9f,1.88f,1.7f,1.85f,1.6f,1.7f,2.2f,1.8f,1.95f,1.9f,2.0f,2.3f,1.93f,3.0f,2.2f,2.5f };
	//char op[200][10] = { "short","medium","medium","tall","medium","medium","tall","medium","short","short","tall","medium","medium","medium","short","medium","short","short","medium","short" };
